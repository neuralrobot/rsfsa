...
if (USER_LOGIN == '1')
{
	if ($user->get('id') != '')
	{
		...
		<div class="toprightmenu">
			<a href="<?php
		echo JRoute::_("index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&view=myvideos"); ?>"><?php
...
if (isset($this->commenttitle) || (isset($dispenable['homeplayer']) && $dispenable['homeplayer'] == 1))
{
	...
	if (isset($this->htmlVideoDetails) && $this->htmlVideoDetails != '')
	{
		...
		else if ($this->htmlVideoDetails->filepath == "File"
			...
			if ($this->homepageaccess == 'true')
			{
						...
						)
				{
					...
					<div id="flashplayer">
						...
						. $split[3]; ?>"  class="iframe_frameborder" webkitallowfullscreen mozallowfullscreen allowfullscreen>
						</iframe>
					</div>
		<?php
				}
...
if ($dispenable['ratingscontrol'] == 1)
{
	?>
						<div class="centermargin floatleft" >
							<div class="rateimgleft" id="rateimg" <?php if($rateduser == 0) { ?>onmouseover="displayrating('');"
								...
								<ul class="ratethis " id="rate" >
									<li class="one" >
										<a title="<?php echo JText::_('HDVS_ONE_STAR_RATING'); ?>"
										   onclick="getrate('1');" <?php if($rateduser == 0) { ?>  onmousemove="displayrating('1');"
										   onmouseout="resetvalue();" <?php } ?>>1</a>
									</li>
									<li class="two" >
										<a title="<?php echo JText::_('HDVS_TWO_STAR_RATING'); ?>"
										   onclick="getrate('2');" <?php if($rateduser == 0) { ?>  onmousemove="displayrating('2');"
										   onmouseout="resetvalue();" <?php } ?>>2</a>
									</li>
									<li class="three" >
										<a title="<?php echo JText::_('HDVS_THREE_STAR_RATING'); ?>"
										   onclick="getrate('3');" <?php if($rateduser == 0) { ?>   onmousemove="displayrating('3');"
										   onmouseout="resetvalue();" <?php } ?>>3</a>
									</li>
									<li class="four" >
										<a  title="<?php echo JText::_('HDVS_FOUR_STAR_RATING'); ?>"
											onclick="getrate('4');" <?php if($rateduser == 0) { ?>  onmousemove="displayrating('4');"
											onmouseout="resetvalue();" <?php } ?> >4</a>
									</li>
									<li class="five" >
										<a title="<?php echo JText::_('HDVS_FIVE_STAR_RATING'); ?>"
										   onclick="getrate('5');" <?php if($rateduser == 0) { ?>  onmousemove="displayrating('5');"
										   onmouseout="resetvalue();" <?php } ?> >5</a>
									</li>
								</ul>
...
?>" />
							...
							<div class="rateright-views floatleft" >
								<span  class="clsrateviews"  id="ratemsg" <?php if($rateduser == 0) { ?> onmouseover="displayrating('');"
									   onmouseout="resetvalue();" <?php } ?>> </span>
								<span  class="rightrateimg" id="ratemsg1" <?php if($rateduser == 0) { ?> onmouseover="displayrating('');"
									   onmouseout="resetvalue();" <?php } ?>>  </span>
							</div>
						</div>
<?php
...
?>
		...
		<a href="<?php echo $rssurl; ?>" class="rssfeedicon" id="rssfeedicon" target="_blank">
		</a></div>
...
?>";
								...
								function changepage(pageno)
								{
									...
									var url = "<?php
	echo JURI::base(); ?>index.php?option=com_contushdvideoshare&view=commentappend&tmpl=component&id=<?php
	echo $this->videodetails->id; ?>&cmdid=2&video_pageid=" + pageno;
