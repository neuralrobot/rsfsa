...
?>"
					...
					<a class="playerpage_morevideos"
					   href="<?php
		echo JRoute::_("index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=featuredvideos"); ?>" title="
<?php
			...
			if ($thumbview['homepopularvideo'] == 1 && $thumbview['homepopularvideoorder'] == $coun_tmovie_post)
			{
				...
				<div id="video-grid-container_pop" class="clearfix">
					<h2 class="home-link hoverable"><a
							href="<?php
		echo JRoute::_("index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=popularvideos"); ?>" title="<?php
...
?>"
					...
					<a class="playerpage_morevideos"
					   href="<?php
		echo JRoute::_("index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=popularvideos"); ?>" title="
<?php
echo JText::_('HDVS_MORE_VIDEOS');
?>"><?php
echo JText::_('HDVS_MORE_VIDEOS');
