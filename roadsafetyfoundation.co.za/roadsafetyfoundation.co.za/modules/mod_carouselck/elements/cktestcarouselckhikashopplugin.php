...
class JFormFieldCktestcarouselckhikashopplugin extends JFormField {

	protected $type = 'cktestcarouselckhikashopplugin';
	...
	protected function getLabel() {
		...
		if ((string) $this->element['hr'] == 'true') {
			...
			$testpatch = $this->testPatch('carouselckckhikashop');
