 ...
 *
 * This file is to display Recent module
 *
 * @category   Apptha
...
<div class="module_menu <?php echo $class; ?> module_videos">
	...
	<div class="video-grid-container clearfix" >
		...
		for ($i = 0; $i < $totalrecords; $i++)
		{
			...
			if($sidethumbview['siderecentvideocol'] == 0)
				$sidethumbview['siderecentvideocol'] = 1;
...
href="<?php echo JRoute::_(
		"index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=player&amp;" . $recentVideoVal . "&amp;"
		. $recentCategoryVal
		); ?>" >
