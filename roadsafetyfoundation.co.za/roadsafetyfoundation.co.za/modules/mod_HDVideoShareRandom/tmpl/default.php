 ...
 *
 * This file is to display the random videos module 
 *
 * @category   Apptha
...
<div class="module_menu <?php echo $class; ?> module_videos">
	...
	<div class="video-grid-container clearfix" >
		...
		for ($i = 0; $i < $totalrecords; $i++)
		{
			...
			if($sidethumbview['siderandomvideocol'] == 0)
				$sidethumbview['siderandomvideocol'] = 1;
...
href="<?php echo JRoute::_(
		"index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=player&amp;" . $randomVideoVal . "&amp;"
		. $randomCategoryVal
		); ?>" >
