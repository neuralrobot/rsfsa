...
?> value="1" />Enable <input type="radio" name="imaads" <?php
			...
			<td class="key">
						<?php echo JHTML::tooltip('Enter the time to start IMA Ad',
								'IMA Ad beginning time', '', 'IMA Ad beginning time'); ?></td>
					<td colspan="3"><input type="text" name="imaadbegin"  value="<?php
