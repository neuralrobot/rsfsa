 ...
 *
 * This file is to display the Featured videos as module 
 *
 * @category   Apptha
...
<div class="module_menu <?php echo $class; ?> module_videos">
	...
	<div class="video-grid-container clearfix" >
		...
		for ($i = 0; $i < $totalrecords; $i++)
		{
			...
			if($sidethumbview['sidefeaturedvideocol'] == 0)
				$sidethumbview['sidefeaturedvideocol'] = 1;
...
href="<?php echo JRoute::_("index.php?Itemid=" . $Itemid . "&amp;option=com_contushdvideoshare&amp;view=player&amp;" . $featuredVideoVal . "&amp;" . $featuredCategoryVal); ?>"
