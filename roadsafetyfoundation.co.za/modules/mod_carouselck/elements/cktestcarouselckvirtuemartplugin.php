...
class JFormFieldCktestcarouselckvirtuemartplugin extends JFormField {
    ...
    protected function getLabel() {
        ...
        if ((string) $this->element['hr'] == 'true') {
            ...
            $testpatch = $this->testPatch('carouselckckvirtuemart');
    ...
    protected function testPatch($component) {
        if (JFile::exists(JPATH_ROOT . '/plugins/system/' . $component .'/'. $component . '.php')
            ...
            return JText::_('PLG_SLIDESHOWCKVIRTUEMART_SPACER_' . strtoupper($component) . '_PATCH_INSTALLED');
        }
        return false;
    }
